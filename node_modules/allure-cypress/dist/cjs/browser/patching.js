  ...
  return function (done) {
    var wrappedDone = hookError => {
      if (hookError) {
        ...
        if (!((_completeSpecOnAfterH = (0, _lifecycle.completeSpecOnAfterHookFailure)(this, hookError)) !== null && _completeSpecOnAfterH !== void 0 && _completeSpecOnAfterH.then(() => done(hookError)))) {
          done(hookError);
        }
        return;
      }
      try {
        ...
        if ((_completeSpecIfNoAfte = (0, _lifecycle.completeSpecIfNoAfterHookLeft)(this)) !== null && _completeSpecIfNoAfte !== void 0 && _completeSpecIfNoAfte.then(() => done())) {
          return;
        }
      } catch (allureError) {
        done(allureError);
...
var wrapAfterFnWithoutArgs = fn => {
  return function () {
    ...
    if (syncError) {
      (0, _lifecycle.throwAfterSpecCompletion)(this, syncError);
    } else if ((0, _sdk.isPromise)(result)) {
      return result.then(() => (0, _lifecycle.completeSpecIfNoAfterHookLeft)(this), asyncError => (0, _lifecycle.throwAfterSpecCompletion)(this, asyncError));
    } else {
